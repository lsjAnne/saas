...
import backend.dashboard.application.DashboardService;
import backend.dashboard.application.DashboardService.BiCockpitView;
import backend.dashboard.application.DashboardService.BiDataQualityCheckView;
import backend.dashboard.application.DashboardService.BiDeliveryChecklistView;
import backend.dashboard.application.DashboardService.BiExternalPlatformOverviewView;
import backend.dashboard.application.DashboardService.BiExportTaskView;
import backend.dashboard.application.DashboardService.BiLayerDefinitionView;
import backend.dashboard.application.DashboardService.BiMarketingAnalysisView;
import backend.dashboard.application.DashboardService.BiMetricDefinitionView;
import backend.dashboard.application.DashboardService.BiOperationalAnalysisView;
import backend.dashboard.application.DashboardService.BiOverviewView;
import backend.dashboard.application.DashboardService.BiRepairTaskView;
import backend.dashboard.application.DashboardService.BiSubscriptionView;
import backend.dashboard.application.DashboardService.BiThemeDomainView;
import backend.dashboard.application.DashboardService.DashboardCampaignAnalysisView;
import backend.dashboard.application.DashboardService.DashboardMemberAnalysisView;
import backend.dashboard.application.DashboardService.DashboardRiskView;
import backend.dashboard.application.DashboardService.DashboardSummaryView;
import backend.dashboard.application.DashboardService.DashboardTrendView;
import backend.dashboard.application.DashboardService.RepairBiDataRequest;
import backend.dashboard.application.DashboardService.SaveBiExportTaskRequest;
import backend.dashboard.application.DashboardService.SaveBiMetricDefinitionRequest;
import backend.dashboard.application.DashboardService.SaveBiSubscriptionRequest;
