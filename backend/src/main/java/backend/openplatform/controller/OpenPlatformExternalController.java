...
import backend.openplatform.application.OpenPlatformApplicationService.ExternalAppProfile;
import backend.openplatform.application.OpenPlatformApplicationService.ExternalDeliveryReadinessOverviewView;
import backend.openplatform.application.OpenPlatformApplicationService.ExternalMessagingCallbackBridgeOverviewView;
import backend.openplatform.application.OpenPlatformApplicationService.ExternalObservabilityReadinessOverviewView;
