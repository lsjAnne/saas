...
public class JdbcStoreRepository implements StoreRepository {
    ...
    public Store save(Store store) {
        if (store.storeId() == null || store.storeId().isBlank()) {
            ...
            if (key == null) {
                throw new IllegalStateException("failed to create store id");
            }
            return new Store(
    ...
    private String toJson(Map<String, Object> values) {
        try {
            ...
            throw new IllegalArgumentException("store metadata serialization failed", exception);
        }
    }
    ...
    private Map<String, Object> fromJson(String values) {
        ...
        try {
            ...
            throw new IllegalArgumentException("store閰嶇疆鍙嶅簭鍒楀寲澶辫触", exception);
        }
    }
