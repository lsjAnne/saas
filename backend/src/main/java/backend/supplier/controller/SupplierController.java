package backend.supplier.controller;
...
import backend.supplier.application.SupplierService.SaveSupplierAdmissionReviewRequest;
import backend.supplier.application.SupplierService.SaveSupplierDeliveryAppointmentRequest;
import backend.supplier.application.SupplierService.SaveSupplierInquiryRequest;
import backend.supplier.application.SupplierService.SaveSupplierRiskEventRequest;
import backend.supplier.application.SupplierService.SaveSupplierScorecardRequest;
import backend.supplier.application.SupplierService.SaveSupplierSettlementStatementRequest;
import backend.supplier.application.SupplierService.SupplierAdmissionReviewView;
import backend.supplier.application.SupplierService.SupplierDeliveryAppointmentView;
import backend.supplier.application.SupplierService.SupplierInquiryQuoteView;
import backend.supplier.application.SupplierService.SupplierInquiryView;
import backend.supplier.application.SupplierService.SupplierRiskEventView;
import backend.supplier.application.SupplierService.SupplierScorecardView;
import backend.supplier.application.SupplierService.SupplierSettlementStatementView;
import backend.supplier.application.SupplierService.SupplierSrmLinkageView;
