...
class TenantAuditLogControllerTest {
    ...
    void shouldReturnOnlyCurrentTenantAuditLogs() throws Exception {
        String tenantA = registerTenant("audit-tenant-a", "13800000001");
        String tenantB = registerTenant("audit-tenant-b", "13800000002");
        String tenantAToken = login("13800000001", "123456");
        String tenantBToken = login("13800000002", "123456");

        createOrganization(tenantAToken, "alpha-org");
        createOrganization(tenantBToken, "beta-org");
    ...
    void shouldExportCurrentTenantAuditLogsAsCsv() throws Exception {
        String tenantA = registerTenant("audit-export-tenant-a", "13800000003");
        registerTenant("audit-export-tenant-b", "13800000004");
        String tenantAToken = login("13800000003", "123456");
        String tenantBToken = login("13800000004", "123456");

        createOrganization(tenantAToken, "gamma-org");
        createOrganization(tenantBToken, "delta-org");
        ...
        mockMvc.perform(get("/api/tenant/audit-logs/export")
                ...
                .andExpect(content().string(org.hamcrest.Matchers.not(org.hamcrest.Matchers.containsString("delta-org"))));
    }
