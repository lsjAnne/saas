...
class MemberFinanceDashboardControllerTest {
    ...
    void shouldGenerateReconcileAndSettleFinanceBill() throws Exception {
                        ...
                        .content("""
                                {
                                  ...
                                  "remark": "finance receipt voucher"
                                }
                        ...
                        .content("""
                                {
                                  ...
                                  "remark": "finance settlement voucher"
                                }
        ...
        mockMvc.perform(withBearerToken(post("/api/finance-invoices/{id}/archive", issuedInvoiceId), fixture.token())
                        ...
                        .content("""
                                {
                                  "remark": "finance invoice confirmation"
                                }
                                """))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.invoiceStatus").value("issued"))
        ...
        mockMvc.perform(withBearerToken(post("/api/finance-invoices/{id}/archive", redFlushInvoiceId), fixture.token())
                        ...
                        .content("""
                                {
                                  "remark": "finance adjustment confirmation"
                                }
                                """))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.invoiceStatus").value("red_flushed"))
                        ...
                        .content("""
                                {
                                  ...
                                  "voucherType": "receipt_voucher",
                                  "voucherAmount": 200.00,
                                  "remark": "finance ledger confirmation"
                                }
                        ...
                        .content("""
                                {
                                  ...
                                  "remark": "finance export confirmation"
                                }
                                """.formatted(orders.largeOrderId())))
                .andExpect(status().isOk())
                .andReturn()
                        ...
                        .content("""
                                {
                                  ...
                                  "remark": "finance data quality confirmation"
                                }
                        ...
                        .content("""
                                {
                                  ...
                                  "dictionaryName": "Receipt Voucher",
                                  "erpCode": "ERP_VOUCHER_RECEIPT",
                                  "erpName": "ERP",
                                  "enabled": true,
                                  "remark": "receipt dictionary"
                                }
                                """))
                .andExpect(status().isOk());
                        ...
                        .content("""
                                {
                                  "dictionaryType": "voucher_type",
                                  "dictionaryCode": "settlement_voucher",
                                  "dictionaryName": "Settlement Voucher ERP",
                                  "erpCode": "ERP_VOUCHER_SETTLEMENT",
                                  "erpName": "ERP-A",
                                  "enabled": true,
                                  "remark": "erp mapping primary"
                                }
                                """))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.erpName").value("ERP-A"));
                        ...
                        .content("""
                                {
                                  ...
                                  "subjectCode": "600101",
                                  "subjectName": "Main sales revenue",
                                  "direction": "credit",
                                  "enabled": true,
                                  "remark": "account mapping"
                                }
                                """.formatted(fixture.storeId())))
                .andExpect(status().isOk())
                        ...
                        .content("""
                                {
                                  ...
                                  "subjectCode": "112201",
                                  "subjectName": "Customer receivable",
                                  "direction": "debit",
                                  "enabled": true,
                                  "remark": "customer receivable mapping"
                                }
                                """.formatted(fixture.storeId())))
                .andExpect(status().isOk());
                        ...
                        .content("""
                                {
                                  ...
                                  "direction": "credit",
                                  "enabled": true,
                                  "remark": "manual subject mapping"
                                }
                                """.formatted(fixture.storeId())))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.subjectCode").value("600199"))
                .andExpect(jsonPath("$.data.subjectName").value("主营业务收入"));
    }
    ...
    void shouldBuildDashboardSummaryRiskCampaignAndMemberAnalysis() throws Exception {
        ...
        mockMvc.perform(withBearerToken(get("/api/dashboard/summary"), fixture.token()))
                ...
                .andExpect(jsonPath("$.data.topSuggestion").value("prioritize replenishment for low stock items before they affect fulfillment"));
    ...
    private void seedDashboardArtifacts(String tenantId, String storeId, String orderId) {
        ...
        exceptionTaskRepository.save(new ExceptionTask(
                ...
                "high",
                "open",
                "delivery timeout needs follow-up",
                "tenant-admin",
                now
        ));
    ...
    private void seedBiArtifacts(String tenantId, String storeId, OrderSeedResult orders) {
        ...
        serviceCaseService.saveTicketSatisfaction(
                tenantId,
                ticketId,
                new ServiceCaseService.SaveTicketSatisfactionRequest(4, "")
        );
    }
