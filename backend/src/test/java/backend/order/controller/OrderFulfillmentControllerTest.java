                        ...
                        .content("""
                                {
                                  ...
                                  "shippingAddress": "Shanghai Pudong Test Road 88"
                                }
                        ...
                        .content("""
                                {
                                  ...
                                  "shippingAddress": "Shanghai Zhangjiang Road 188"
                                }
                                """.formatted(fixture.storeId(), fixture.productId())))
                .andExpect(status().isOk())
                .andReturn();
                        ...
                        .content("""
                                {
                                  ...
                                  "riskLevel": "low",
                                  "recommendationReason": "鍙敤浜庤鍗曞饱绾︿富閾捐矾楠岃瘉",
                                  "aiSummary": "绯荤粺鐢熸垚璁㈠崟娴嬭瘯鍟嗗搧"
                                }
                                """.formatted(storeId)))
                .andExpect(status().isOk())
                .andReturn();
