...
class AdminTenantListControllerTest {
    ...
    @Test
    void shouldReturnAdminTenantOverviewList() throws Exception {
        ...
        mockMvc.perform(get("/api/admin/tenants")
                ...
                .andExpect(jsonPath("$.data[0].tenantName").value("鏄熻景鐢靛晢"))
                .andExpect(jsonPath("$.data[0].planCode").value("trial"))
                .andExpect(jsonPath("$.data[0].quotaCount").value(3));
    }
}
