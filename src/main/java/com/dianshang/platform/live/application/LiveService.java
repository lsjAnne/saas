...
public class LiveService {
    ...
    public record CreateLivePlanRequest(
            @NotBlank(message = "storeId涓嶈兘涓虹┖")
            String storeId,
            String liveAccountId,
            @NotBlank(message = "planName涓嶈兘涓虹┖")
            String planName,
            @NotNull(message = "scheduledStartAt涓嶈兘涓虹┖")
    ...
    public record SimulateLiveCallbackRequest(
            @NotBlank(message = "eventType涓嶈兘涓虹┖")
            String eventType,
            String errorMessage
    ) {
    }
    ...
    public record StrongControlRequest(
            @NotBlank(message = "controlMode不能为空")
            String controlMode,
            String reason
    ) {
    }
    ...
    public record SwitchSceneRequest(
            @NotBlank(message = "targetScene不能为空")
            String targetScene,
            String reason
    ) {
    }
    ...
    public record ManualTakeoverRequest(
            @NotBlank(message = "takeoverOperator不能为空")
            String takeoverOperator,
            String reason
    ) {
    }
    ...
    public record PromiseAuditRequest(
            @NotBlank(message = "promiseText不能为空")
            String promiseText,
            @NotBlank(message = "riskLevel不能为空")
            String riskLevel,
